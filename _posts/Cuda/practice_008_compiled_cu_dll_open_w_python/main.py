...
# CUDA 커널 파일(.obj) 경로
# path=r'D:\GitHub_Project\koyumi0601.github.io\_posts\Cuda\practice_008_compiled_cu_dll_open_w_python\kernel.cu.obj'
cuda_kernel_file = os.path.abspath('D:/GitHub_Project/koyumi0601.github.io/_posts/Cuda/practice_008_compiled_cu_dll_open_w_python/kernel.cu.dll')
dll_path = r'D:\GitHub_Project\koyumi0601.github.io\_posts\Cuda\practice_008_compiled_cu_dll_open_w_python\kernel.cu.dll'
your_dll = ctypes.cdll.LoadLibrary(dll_path)
