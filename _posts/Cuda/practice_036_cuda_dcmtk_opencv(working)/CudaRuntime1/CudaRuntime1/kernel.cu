...
int main()
{
    //std::string path = "D:/Github_Blog/koyumi0601.github.io/_posts/Cuda/practice_036_cuda_dcmtk_opencv/ConsoleApplication1/ConsoleApplication1/image_00001.png";
    //cv::Mat img2 = cv::imread(path);
    //if (img2.empty()) // 이미지가 제대로 로드되었는지 확인
    //{
    ...
    std::string dicomFile = "D:/Github_Blog/koyumi0601.github.io/_posts/Cuda/practice_036_cuda_dcmtk_opencv/CudaRuntime1/CudaRuntime1/1.2.276.0.7230010.3.1.4.301774566.4480.1683581601.503";
