...
class MainWindow : public QMainWindow
{
    ...
    private:
        ...
        QGraphicsRectItem* stencilRectItem0;
        QGraphicsRectItem* stencilRectItem1;
        QGraphicsRectItem* stencilRectItem2;
        QGraphicsRectItem* stencilRectItem3;
        QTimer* updateTimer;
