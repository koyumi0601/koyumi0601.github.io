    ...
    , ui(new Ui::MainWindow)
{
    ...
    userdata.orgImgWidth = cvOrgImage.cols;
    userdata.orgImgHeight = cvOrgImage.rows;
    userdata.scaledOrgImg = cvImage.clone();
    userdata.scaledupdatedImg = cvImage.clone();
    userdata.scaledImgWidth = cvImage.cols;
    userdata.scaledImgHeight = cvImage.rows;
    userdata.isRoiDetermined = false;
    userdata.isThereCandidate = false;

    userdata.widthFactor = (float)userdata.orgImgWidth / (float)userdata.scaledImgWidth;
    userdata.heightFactor = (float)userdata.orgImgHeight / (float)userdata.scaledImgHeight;

    std::cout << "orgImgWidth = " << userdata.orgImgWidth << ", scaledImgWidth = " << userdata.scaledImgWidth << std::endl;
    std::cout << "orgImgHeight = " << userdata.orgImgHeight << ", scaledImgHeight = " << userdata.scaledImgHeight << std::endl;
    std::cout << "widthFactor = " << userdata.widthFactor << ", heightFactor = " << userdata.heightFactor << std::endl;
...
void MainWindow::onPushButtonClicked()
{
    ...
    if (userdata.isRoiDetermined)
    {
        // std::cout << "orgImgWidth = " << (int)userdata.orgImgWidth << ", scaledImgWidth = " << (int)userdata.scaledImgWidth << std::endl;
        // std::cout << "orgImgHeight = " << (int)userdata.orgImgHeight << ", scaledImgHeight = " << (int)userdata.scaledImgHeight << std::endl;
        std::cout << "widthFactor = " << userdata.orgImg.cols << ", heightFactor = " << userdata.orgImg.rows << std::endl;
